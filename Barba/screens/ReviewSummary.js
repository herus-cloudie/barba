        ...
        <View style={[styles.summaryContainer, { 
           backgroundColor: dark ? COLORS.dark2 : COLORS.white,
            ...
            <View style={styles.view}>
              ...
              <Text style={[styles.viewRight,{  color: dark ? COLORS.white : COLORS.greyscale900 }]}>Barbarellla Inova</Text>
            </View>
            <View style={styles.view}>
            ...
            <View style={styles.view}>
              ...
              <Text style={[styles.viewRight, {  color: dark ? COLORS.white : COLORS.greyscale900 }]}>10:00 AM</Text>
            </View>
            <View style={styles.view}>
              <Text style={styles.viewLeft}>Specialist</Text>
              <Text style={[styles.viewRight, {  color: dark ? COLORS.white : COLORS.greyscale900 }]}>Nathan Alexander</Text>
            </View>
          </View>
          ...
          <View style={[styles.summaryContainer, { 
            ...
            <View style={styles.view}>
              ...
              <Text style={[styles.viewRight, {  color: dark ? COLORS.white : COLORS.greyscale900 }]}>$6.00</Text>
            </View>
            <View style={styles.view}>
            ...
            <View style={styles.view}>
              ...
              <Text style={[styles.viewRight, {  color: dark ? COLORS.white : COLORS.greyscale900 }]}>$4.55</Text>
            </View>
